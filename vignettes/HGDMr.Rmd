---
title: "HGDMr | Hysteretic and Gatekeeping Depressions Model"
author: "Kevin Shook"
date: "`r Sys.Date()`"
output: 
  rmarkdown::html_vignette:
    ...
    number_sections: yes
vignette: >
  %\VignetteIndexEntry{HGDMr | Hysteretic and Gatekeeping Depressions Model}
...
fraction](hysteresis_model.png){#fig-hyseresis width="5cm"}
...
HGDM](basin_schematic.png){#fig-schematic width="5cm"}
...
![HGDM flowchart](HGDM_flowchart.png){#fig-HGDMflowchart width="5cm"}
...
destinations as shown in @fig-HGDMflowchart. The fractions can be
...
In these examplse, the parameter values are *not* based on an actual
...
## Plotting the differences in annual peak discharges
